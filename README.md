...
# 注意事项
1. 若是有用前端页面，后端地址一栏要这么填写,其中的文件名要注意调整下：https://api.dler.io/sub?config=https://raw.githubusercontent.com/fengbird/chatgpt-openclash/main/Full.ini&filename=xxx&
